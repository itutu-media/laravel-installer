...
class LaravelInstallerCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        if (($this->option('modules') || class_exists(\Nwidart\Modules\LaravelModulesServiceProvider::class))) {
            ...
            // Create a new ChoiceQuestion instance
            $question = new ChoiceQuestion(
                'Please select the modules you want to enable (comma separated)',
                $moduleNames
            );
            ...
            $selectedModules = $helper->ask($this->input, $this->output, $question);
